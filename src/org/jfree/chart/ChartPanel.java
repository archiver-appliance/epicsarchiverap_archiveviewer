 ...
 *                   Matthias Rose;
 *
 * $Id: ChartPanel.java,v 1.2 2007/01/31 02:28:05 rdh Exp $
 *
 * Changes (from 28-Jun-2001)
 * --------------------------
 * 28-Jun-2001 : Integrated buffering code contributed by Sren Caspersen (DG);
...
public class ChartPanel extends JPanel 
    ...
    public void createChartPrintJob() {
        ...
        // Change the default orientation to Landscape.
        // Previously the default orientation was Portrait.
        pf.setOrientation(PageFormat.LANDSCAPE);

        // Change the default paper size to Letter, the
        // Standard U.S. 8 1/2 x 11 inch size.  Previously
        // the default paper size was A4.
        Paper paper = pf.getPaper();

        // The setSize parameter dimensions are in 1/72nds of an inch.
        ...
        if (pf2 != pf) {
            ...
            ChoosePrintService choosePrintService = new ChoosePrintService();

            PrintService service = choosePrintService.getPrintService();
            if (service != null) {
                try {
	...
	public void setHorizontalTraceLine(Line2D horizontalTraceLine) {
	...
	public void setVerticalTraceLine(Line2D verticalTraceLine) {
